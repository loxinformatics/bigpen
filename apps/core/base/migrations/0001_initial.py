...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('site_name', 'Site Name'), ('site_description', 'Site Description'), ('site_url', 'Site URL'), ('site_theme_color', 'Site Theme Color')], max_length=25, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('site_logo', 'Site Logo'), ('site_favicon', 'Site Favicon'), ('site_apple_touch_icon', 'Site Apple Touch Icon')], max_length=25, unique=True)),
