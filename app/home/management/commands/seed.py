...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if fixture_dir:
            ...
            fixture_files = list(fixture_path.rglob(f"*.{extension}"))
        ...
        # Case 2: Loading from app fixtures directories
            ...
            if app_label:
                ...
                try:
                    ...
                    fixture_files = list(app_fixtures_path.rglob(f"*.{extension}"))
                except LookupError:
                ...
                for app_config in apps.get_app_configs():
                    app_fixtures_path = Path(app_config.path) / "fixtures"
                    fixture_files.extend(app_fixtures_path.rglob(f"*.{extension}"))
