    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Main image for the item.', upload_to='shop/items/')),
                ('icon', models.CharField(blank=True, help_text='Optional. Icon class or path for the item.', max_length=255)),
                ('short_description', models.TextField(blank=True, help_text='Optional. Short description of the item.')),
                ('long_description', models.TextField(blank=True, help_text='Optional. Detailed description of the item.')),
