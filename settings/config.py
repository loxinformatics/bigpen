...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS", cast=Csv(), default="localhost,127.0.0.1,code.treeolive.tech"
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # custom
                "core.context_processors.provider",
                # "accounts.context_processors.accounts",
                # "blog.context_processors.provider",
                # "gallery.context_processors.gallery",
                # "home.context_processors.home",
                # "lessons.context_processors.lessons",
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    ...
    "accounts.backends.CustomUserModelBackend",  # Add your custom backend
]
